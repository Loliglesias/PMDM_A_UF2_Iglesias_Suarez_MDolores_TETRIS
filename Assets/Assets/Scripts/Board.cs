...
public class Board : MonoBehaviour
{
    ...
    public Vector3 nextPieceScale = new Vector3(0.5f, 0.5f, 1f); // Tamaño da peza
    ...
    [SerializeField] public float speedIncreasePerLine = 0.005f; // Incremento de velocidade por cada liña eliminada
    private const string DATA_FILE = "scoreData.json"; // Arquivo onde gardamos os datos de puntuacións do xogador
    [SerializeField] GameManager game; // Instancia do GameManager
    [SerializeField] LevelManager levelManager; // Instancia de LevelManager
...
*/
    ...
    */
    private void GenerateNextPiece(GameObject nextPiecePrefab)
    {
        GameObject nextPieceObject = Instantiate(nextPiecePrefab, nextPieceSpawnPoint.position, Quaternion.identity);
    ...
    */
...

    {
        ...
        {
            Debug.LogError("Índice de peza fora de rango: " + nextPieceIndex);
            return null;
        }
    }
