...
{
    public BoardBlock board { get; private set; } // Instanciación de Board
    ...
    */
    public void Initialize(BoardBlock board, Vector3Int position, TetrominoData data)
    {
    ...
    */
    ...
    {
        float newStepDelay = stepDelay - increaseAmount * 5;
        newStepDelay = Mathf.Max(newStepDelay, board.minStepDelay);
        stepDelay = newStepDelay;
    }

    /*
    Constructor da peza cun BoardBlock asociado como parámetro
    */
    public PieceBlock(BoardBlock board)
    {
        this.board = board;
    }
