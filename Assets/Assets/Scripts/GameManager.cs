...
public class GameManager : MonoBehaviour
{
    ...
    */
    public void HandleGameOver()
    {
        ...
        if (isNameInputSubmitted)
        {
            ...
            Time.timeScale = 0f;
           // Debug.Log("Pauso xogo en Handle gameover - restarting");
        }
    }
    ...
    */
    public void SaveData(string playerName, int score, float time)
    {
        ...
        // Crear un nuevo ScoreData y agregarlo a la lista
    ...
    // Parte de selección de niveis
    public void SetLevelNormal()
    {
        board.activePiece.stepDelay = 1;
        StartGame();
    }
    public void SetLevelMedio()
    {
        board.activePiece.stepDelay = 0.5f;
        StartGame();
    }
    public void SetLevelDificil()
    {
        board.activePiece.stepDelay = 0.3f;
        StartGame();
    }
